...
describe("event-dedupe-service", () => {
  ...
  it("recordProcessedEvent writes the row", async () => {
    ...
    await recordProcessedEvent(db, "app-b", "e1", "SessionRevoked", "local_session_revoked");
